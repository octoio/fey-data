...
(* Generated code comment template *)
let generated_comment_header = [
  (`Field, "/// <summary>");
  (`Field, "/// This file is auto-generated by the fey-data OCaml pipeline.");
  (`Field, "/// DO NOT MODIFY - Your changes will be overwritten on next generation.");
  (`Field, "/// </summary>");
  blank_line
]
